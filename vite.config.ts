...
// Deterministic scoped names keep the static render and the client script bundle in sync.
...
export default defineConfig({
  ...
  logLevel: `warn`,
  // Types are only written during builds, so `bun run build` refreshes them.
